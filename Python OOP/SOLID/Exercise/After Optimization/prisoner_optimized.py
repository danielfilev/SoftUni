...
# This is a test exercise of the Liskov Substitution Principle.
...
# Answer should be:
# The prisoner trying to walk to north by 10 and east by - 3. The location of the prison: (3, 3) The current position of the prisoner: (3, 3)
